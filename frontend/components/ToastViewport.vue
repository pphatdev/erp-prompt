    ...
    <Teleport to="body">
        <div class="toast-viewport" role="region" aria-label="Notifications">
            <TransitionGroup name="toast" tag="div" class="toast-stack">
                <article v-for="t in toasts" :key="t.id" class="toast"
                    :class="[`toast--${t.color}`, paused.has(t.id) ? 'is-paused' : '']" role="status" aria-live="polite"
                    @mouseenter="pause(t.id)" @mouseleave="resume(t.id)" @focusin="pause(t.id)"
                    ...
                    <div class="toast-body">
                        ...
                        <div class="toast-content">
                            ...
                            <button v-if="t.actionLabel" type="button" class="toast-action"
                                :class="`toast-action--${t.color}`" @click="invokeAction(t)">
                                {{ t.actionLabel }}
                            </button>
                        </div>
...
<style scoped>
    ...
    .toast--primary .toast-progress>span {
    ...
    .toast--danger .toast-progress>span {
    ...
    .toast--secondary .toast-progress>span {
