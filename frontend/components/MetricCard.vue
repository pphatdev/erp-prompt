<template>
  <div class="glass-card rounded-xl p-5 flex flex-col gap-4 relative overflow-hidden group">
    ...
    <div
      class="absolute -top-6 -right-6 w-24 h-24 rounded-full blur-2xl opacity-50 pointer-events-none"
      :class="glowClass"
    />
    ...
    <div class="relative z-10">
      <div class="flex items-baseline gap-2 flex-wrap">
        ...
        <span
          ...
          :class="deltaClass"
        >
          <i class="ti text-[10px]" :class="deltaDirection === 'up' ? 'ti-trending-up' : 'ti-trending-down'" />
          {{ delta }}
        </span>
      </div>
