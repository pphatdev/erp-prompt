...
const kpiCards = computed(() => [
    { key: 'total',     label: 'Total services',  value: totalCount.value.toLocaleString(),     icon: 'ti-tool',           tone: 'primary', subtext: 'Lifetime records' },
    ...
    { key: 'totalCost', label: 'Total cost',      value: formatMoney(totalCostCount.value),     icon: 'ti-cash',           tone: 'warning', subtext: 'Lifetime spend' },
    { key: 'avgCost',   label: 'Avg per service', value: formatMoney(avgCostCount.value),       icon: 'ti-chart-bar',      tone: 'success', subtext: 'Per visit' },
])
