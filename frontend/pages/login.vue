  ...
  <NuxtLayout name="auth">
    <div class="glass-card rounded-2xl p-8 shadow-(--shadow-lg) relative">
      <div class="flex flex-col items-center mb-8">
        <div class="w-12 h-12 rounded-xl bg-linear-to-tr from-(--color-primary) to-(--color-info) flex items-center justify-center font-bold text-white shadow-(--shadow-md) mb-4">
      ...
      <div v-if="errorMsg" class="mb-6 px-4 py-3 rounded-lg badge-soft-danger flex items-center gap-2 text-xs font-semibold">
      ...
      <form @submit.prevent="submitLogin" class="space-y-5">
        <div v-if="!hasSubdomain">
          <label class="block text-[10px] font-bold text-(--text-muted) uppercase tracking-wider mb-2">Company Handle</label>
          <div class="relative">
        ...
        <div>
          <label class="block text-[10px] font-bold text-(--text-muted) uppercase tracking-wider mb-2">Email Address</label>
          <input v-model="email" type="email" required placeholder="admin@example.com" class="form-control" />
        </div>

        <div>
          <div class="flex items-center justify-between mb-2">
            <label class="block text-[10px] font-bold text-(--text-muted) uppercase tracking-wider">Password</label>
            <a class="text-[10px] text-(--color-primary) font-semibold hover:underline cursor-pointer">Forgot password?</a>
          </div>
      ...
      <div class="mt-8 text-center text-[10px] text-(--text-muted) border-t border-(--border-color) pt-6 font-mono uppercase tracking-widest">
