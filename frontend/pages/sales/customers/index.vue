        ...
        <div class="space-y-6">
            ...
            <section class="glass-card rounded-xl p-4 flex flex-col md:flex-row gap-3 items-center justify-between">
                <div class="relative w-full md:w-96">
                    ...
                    <input v-model="search" type="search" placeholder="Search name, email, company, external code..."
                ...
                <div class="flex flex-col sm:flex-row gap-2 items-center w-full md:w-auto">
                    ...
                    <div
                        class="flex items-center border border-(--border-color) rounded-lg bg-(--bg-muted) p-1 shrink-0">
                    ...
                    <footer
                        ...
                        <div class="flex gap-1.5">
                            ...
                            <button type="button" class="action-btn action-btn-danger" title="Archive"
                                @click="confirmDelete(c)"><i class="ti ti-trash" /></button>
                        </div>
                    </footer>
                </article>
            </section>
        ...
        <div v-if="deleteTarget"
            ...
            <div class="glass-card rounded-2xl w-full max-w-md bg-(--bg-card) shadow-(--shadow-lg)">
                <header class="flex items-center justify-between p-5 border-b border-(--border-color)">
                    ...
                    <button type="button" class="w-8 h-8 rounded-full hover:bg-(--bg-muted)"
                        @click="deleteTarget = null"><i class="ti ti-x" /></button>
                </header>
                <div class="p-5 space-y-2">
                    <p class="text-xs text-(--text-body)">
                        Archive <span class="font-semibold text-(--text-heading)">{{ deleteTarget.name }}</span>?
                    </p>
                    <p class="text-xxs text-(--text-muted)">Historical quotes, orders, invoices, and subscriptions stay
                        intact.</p>
