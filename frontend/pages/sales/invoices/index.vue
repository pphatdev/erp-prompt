        ...
        <div class="space-y-6">
            <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div>
                    ...
                    <p class="text-xs text-(--text-muted) mt-1">Confirming an invoice posts the balanced AR journal to
                        the GL.</p>
                </div>
            </header>
            ...
            <section class="glass-card rounded-xl p-4 flex flex-col md:flex-row gap-3 items-center justify-between">
                <div class="relative w-full md:w-80">
                    ...
                    <input v-model="search" type="search" placeholder="Search invoice # or customer..."
            ...
            <div v-else-if="filtered.length === 0" class="glass-card rounded-2xl py-20 text-center">
                ...
                <p class="text-xs text-(--text-muted) mt-1">Invoices are created automatically when a Sales Order is
                    confirmed.</p>
            </div>
