...
return [
    ...
    |
    | Note: We keep the default guard as 'web' so that Auth::attempt()
    | works seamlessly for session validation during login, but
    | secure API routes use the 'api' guard with Passport.
    |
    */
    ...
    */
    ...
    | system that is used by this application. Typically, Eloquent is used.
    |
    ...
    */
    ...
    | generating more password reset tokens. This prevents abuse.
    |
    */
