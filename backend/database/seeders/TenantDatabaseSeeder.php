    ...
    private function seedWorkflowStatuses(): void
    {
        ...
        $modules = [
            'hrm.application' => [
                ...
                ['key' => 'assessment_completed', 'label' => 'Assessment Completed', 'color' => 'info',      'icon' => 'ti-clipboard-check','sequence' => 5,  'is_initial' => false, 'is_terminal' => false, 'allowed_next' => ['interview', 'final_interview', 'offer', 'rejected', 'withdrawn']],
                ['key' => 'interview',            'label' => 'Interview',            'color' => 'warning',   'icon' => 'ti-message-circle', 'sequence' => 6,  'is_initial' => false, 'is_terminal' => false, 'allowed_next' => ['final_interview', 'offer', 'rejected', 'withdrawn']],
                ['key' => 'final_interview',      'label' => 'Final Interview',      'color' => 'warning',   'icon' => 'ti-microphone-2',   'sequence' => 7,  'is_initial' => false, 'is_terminal' => false, 'allowed_next' => ['offer', 'rejected', 'withdrawn']],
                ['key' => 'offer',                'label' => 'Job Offer',            'color' => 'primary',   'icon' => 'ti-mail-share',     'sequence' => 8,  'is_initial' => false, 'is_terminal' => false, 'allowed_next' => ['hired', 'rejected', 'withdrawn']],
                // hired is event-driven (offer accept) — recruiters cannot jump here manually.
                ['key' => 'hired',                'label' => 'Hired',                'color' => 'success',   'icon' => 'ti-circle-check',   'sequence' => 9,  'is_initial' => false, 'is_terminal' => false, 'allowed_next' => ['onboarding', 'rejected', 'withdrawn']],
                // onboarding is event-driven (appointment approval) — terminal-success row.
                ['key' => 'onboarding',           'label' => 'Onboarding',           'color' => 'success',   'icon' => 'ti-checklist',      'sequence' => 10, 'is_initial' => false, 'is_terminal' => true,  'allowed_next' => []],
